...
int
encode_ChopstixName(unsigned char *p, size_t len, const ChopstixName *data, size_t *size)
{
size_t ret = 0;
size_t l;
int i, e;
...
int
decode_ChopstixName(const unsigned char *p, size_t len, ChopstixName *data, size_t *size)
{
...
size_t
length_ChopstixName(const ChopstixName *data)
{
size_t ret = 0;
